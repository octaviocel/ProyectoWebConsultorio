...
namespace ProyectoConsultorio.Controllers
{
    public class EmpleadoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdEmpleado,Nombre,Rol,Activo")] Empleado empleado)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdEmpleado,Nombre,Rol,Activo")] Empleado empleado)
        {
